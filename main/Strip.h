...
auto speed0 = std::vector<int>{3968,3968,3663,3968,3401,3663,3401,4762};
auto speed1 = std::vector<int>{3805,3805,3513,3805,3262,3513,3262,4566};
auto speed2 = std::vector<int>{3546,3546,3273,3546,3040,3273,304,4255,};
auto speedcustom = std::vector<int>{3968,3968,3663,3968,3401,3663,3401,4762};
...
public:
  ...
  const char *LIGHT_CHAR_SPEEDCUSTOM_UUID = "765961ad-e273-ddda-ce56-25a46e3017f9";
 std::map<int, float> m ;
 ValueRetriever<float> *cur_speed0 = new ValueRetriever<float>(m);
 ValueRetriever<float> *cur_speed1 = new ValueRetriever<float>(m);
 ValueRetriever<float> *cur_speed2 = new ValueRetriever<float>(m);
 ValueRetriever<float> *cur_speedCustom = new ValueRetriever<float>(m);
  /**
